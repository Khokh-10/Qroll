...
<div class="container mt-5">
    ...
    <div class="d-flex justify-content-between mb-3">
        ...
        <a href="{{ route('teachers.create') }}" class="btn btn-dark">+ Add New Doctor</a>
    </div>
        ...
        <table class="table table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ route('teachers.show', $doctor->id) }}" class="btn btn-dark btn-sm">View</a>

                        <form action="{{ route('teachers.destroy', $doctor->id) }}" method="POST" class="d-inline">
                            @csrf   
                            @method('DELETE')
